      ...
      <main className="  ">
        ...
        <section id="about" className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-700 dark:text-gray-300 max-w-prose">
              ...
              <br /> Specializing in React, TypeScript, and TailwindCSS, I bring
              a creative and technical approach to every project.
            </p>
          </div>
        ...
        <footer className="bg-gray-900 text-white py-6 text-center">
          <div className="container mx-auto px-4">
            <p className="text-gray-300 mb-4">
              Copyright © 2025 Mohamed Moughamir. All rights reserved.
            </p>
